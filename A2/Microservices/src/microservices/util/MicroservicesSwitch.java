...
public class MicroservicesSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case MicroservicesPackage.SERVER_NODE: {
				ServerNode serverNode = (ServerNode)theEObject;
				T result = caseServerNode(serverNode);
				if (result == null) result = caseNamed(serverNode);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MicroservicesPackage.VIRTUAL_MACHINE: {
				...
				if (result == null) result = caseNamed(virtualMachine);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MicroservicesPackage.CONTAINER: {
				...
				if (result == null) result = caseNamed(container);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MicroservicesPackage.MICROSERVICE: {
				...
				if (result == null) result = caseNamed(microservice);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Server Node</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Server Node</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseServerNode(ServerNode object) {
		return null;
	}
